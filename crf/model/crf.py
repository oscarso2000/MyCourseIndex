...
from model.feature import FeatureSet, STARTING_LABEL_INDEX
...
class LinearChainCRF():
    ...
    def _get_training_feature_data(self, training_data):
        return [[self.feature_set.get_feature_list(X, t) for t in range(len(X))]
                for X, _ in training_data]

    def _estimate_parameters(self, training_data):
        """
        ...
        * References:
        ...
        """
        training_feature_data = self._get_training_feature_data(training_data)
    ...
    def train(self, training_data, model_filename):
        """
        ...
        self.feature_set.scan(training_data)
        ...
        self._estimate_parameters(training_data)
